...
Pourquoi ça marche : le périmètre est étroit, les données d'entrée sont structurées ou semi-structurées, la décision à prendre est finie (3 à 10 destinations possibles), et l'impact est immédiatement mesurable (temps économisé, taux de conversion).
