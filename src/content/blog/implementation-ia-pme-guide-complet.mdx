...
Chaque projet IA réussi que nous avons livré avait un référent métier interne qui y consacrait au moins un demi-jour par semaine. Son rôle : valider les sorties du système, remonter les anomalies, former ses collègues, être l'interface entre l'équipe technique et les utilisateurs finaux. Sans ce rôle, le projet décroche dans les 2 mois qui suivent la livraison.
