...
Lorsque vos documents sont diffuses au format PDF, leur [localisation necessite une attention particuliere](/blog/localisation-pdf-professionnels) : polices, mise en page et calques de texte doivent etre traites specifiquement pour garantir un rendu professionnel dans chaque langue cible.
