...
Pourtant, quand ces entreprises se développent à l'international, la localisation de ces documents est souvent reléguée au second plan. On traduit [le site web en veillant à ne pas perdre son référencement](/blog/traduire-site-web-seo), on sous-titre les vidéos, mais les PDF restent en français. C'est une erreur stratégique majeure.
...
Si votre stratégie de localisation s'étend au-delà des PDF, notre guide sur [la localisation d'application mobile : les erreurs à éviter](/blog/localisation-application-mobile) couvre les défis spécifiques à ce type de projet — des contraintes techniques aux pièges linguistiques.
...
**Enjeu principal :** l'impact marketing. La brochure doit donner envie d'acheter dans la langue cible autant que dans la version originale. Pour une vision d'ensemble de la localisation de tous vos supports de vente à l'export — présentations, vidéos, fiches et emails — notre guide sur [comment localiser vos supports de vente pour l'export](/blog/localiser-supports-vente) couvre chaque dimension de ce chantier.
...
- Traduction des conditions générales de vente — notre guide sur [comment traduire vos CGV et mentions légales pour l'international](/blog/traduire-cgv-mentions-legales) détaille les exigences juridiques par marché
