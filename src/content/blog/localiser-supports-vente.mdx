...
La proposition commerciale est le document le plus sensible. Sa localisation doit integrer les pratiques commerciales locales : structure du document, conditions de paiement habituelles, mentions legales requises et format de presentation du prix. Pour les documents juridiques comme les CGV et mentions légales, notre guide sur [la traduction de vos CGV et mentions légales pour l'international](/blog/traduire-cgv-mentions-legales) couvre les exigences reglementaires par pays.
...
**Oublier la version numerique.** Vos supports sont souvent partages par email en PDF. La [localisation de documents PDF professionnels](/blog/localisation-pdf-professionnels) suit des regles specifiques pour garantir la fidelite visuelle et la lisibilite. Verifiez que les liens sont fonctionnels, que les polices s'affichent correctement et que le poids du fichier reste raisonnable.
