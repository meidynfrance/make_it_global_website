...
Pour une analyse approfondie des avantages et inconvenients de chaque option, notre guide sur la [structure de site multilingue](/blog/structure-site-multilingue) compare en detail sous-domaines, sous-repertoires et ccTLD.
...
Les erreurs de configuration hreflang sont extremement courantes et peuvent nuire severement a votre referencement international. Verifiez systematiquement que chaque page reference toutes ses versions linguistiques et qu'elle se reference elle-meme. Pour une implementation sans erreur, notre [guide complet des balises hreflang](/blog/guide-hreflang) détaille toutes les règles de syntaxe et les méthodes de validation.
...
- **[Google Search Console](/blog/search-console-international)** : permet de filtrer les donnees par pays et d'identifier les erreurs hreflang
