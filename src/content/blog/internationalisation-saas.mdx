...
- Webinaires et contenus de formation (pour les SaaS à dimension pédagogique, voir notre [guide de localisation des plateformes EdTech](/blog/localisation-edtech) pour les enjeux spécifiques aux LMS et au e-learning)
- Documentation API et technique

Pour la documentation technique, les exigences de localisation sont particulieres : notre guide sur [la localisation de documentation technique multilingue](/blog/documentation-technique-multilingue) detaille les bonnes pratiques pour les contenus industriels et techniques complexes.
