---
title: "Localiser une plateforme EdTech : guide international 2026"
...
Si votre plateforme delivre des certifications ou des diplomes, verifiez leur reconnaissance dans chaque marche cible. Vous devrez peut-etre obtenir des accreditations locales ou etablir des partenariats avec des institutions educatives reconnues. Les exigences de documentation localisee constituent un enjeu transversal pour de nombreux secteurs — notre guide sur [la localisation de documentation technique multilingue](/blog/documentation-technique-multilingue) developpe les bonnes pratiques pour les contenus soumis a des normes strictes. Pour les organismes de formation qui souhaitent exporter leurs modules pédagogiques, notre guide sur [la traduction de modules de formation pour l'export](/blog/organismes-formation-export) couvre les étapes spécifiques a ce type de contenu.
