---
title: "Organismes de formation : traduire vos modules pour l'export"
...
Quelle que soit la cible visee, une strategie structuree est indispensable avant de franchir le pas — notre guide [quand et comment internationaliser votre activite de startup](/blog/internationalisation-startup) pose les bases essentielles pour evaluer sa maturite a l'export. Pour les acteurs dont l'offre repose sur une plateforme en ligne, notre [guide de localisation des plateformes EdTech](/blog/localisation-edtech) couvre les specificites techniques et pedagogiques propres aux solutions d'apprentissage numerique.
